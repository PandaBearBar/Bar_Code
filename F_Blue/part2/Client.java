...
abstract class Client {
    ...
    public void withdraw(Account account, double amount) {
        ...
        if (account == findAccountById(account.getAccountID())) {
            ...
            if (account.getBalance() >= netoWithdraw) {
                System.out.println("Deposit successfully");
            ...
            } else System.out.println("No Overdraft");
        } else System.out.println("Account does not exist");
    }
    ...
    public void autoUpdateAccount() {
        ...
        for (Account a: accounts) {
            double interestAmount = a.getBalance() + (a.getBalance() * interestRate / 100);
            accounts.get(i).setBalance(interestAmount);
            i++;
            Logger.getInstance().addLog(new Log(a.getAccountID(), "Interest added", interestAmount));
        }
    }
